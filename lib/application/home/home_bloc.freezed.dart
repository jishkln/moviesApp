...
mixin _$HomeState {
  ...
  List<HotAndNewData> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get treandingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tenceDramaMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> treandingMovieList,
      List<HotAndNewData> tenceDramaMovieList,
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? treandingMovieList = freezed,
    Object? tenceDramaMovieList = freezed,
    Object? treandingTvList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      treandingMovieList: treandingMovieList == freezed
          ? _value.treandingMovieList
          : treandingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tenceDramaMovieList: tenceDramaMovieList == freezed
          ? _value.tenceDramaMovieList
          : tenceDramaMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      treandingTvList: treandingTvList == freezed
    ...
    return _then(_$_Initial(
      ...
      pastYearMovieList: pastYearMovieList == freezed
          ...
          : pastYearMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      treandingMovieList: treandingMovieList == freezed
          ? _value._treandingMovieList
          : treandingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tenceDramaMovieList: tenceDramaMovieList == freezed
          ? _value._tenceDramaMovieList
          : tenceDramaMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      treandingTvList: treandingTvList == freezed
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> treandingMovieList,
      required final List<HotAndNewData> tenceDramaMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        _treandingMovieList = treandingMovieList,
        _tenceDramaMovieList = tenceDramaMovieList,
  ...
  final List<HotAndNewData> _treandingMovieList;
  @override
  List<HotAndNewData> get treandingMovieList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_treandingMovieList);
  }

  final List<HotAndNewData> _tenceDramaMovieList;
  @override
  List<HotAndNewData> get tenceDramaMovieList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tenceDramaMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, treandingMovieList: $treandingMovieList, tenceDramaMovieList: $tenceDramaMovieList, treandingTvList: $treandingTvList, southIndianMovieList: $southIndianMovieList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._treandingMovieList, _treandingMovieList) &&
            const DeepCollectionEquality()
                .equals(other._tenceDramaMovieList, _tenceDramaMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_treandingMovieList),
      const DeepCollectionEquality().hash(_tenceDramaMovieList),
